...
pub async fn do_signal(id: SigId, sa: UserspaceSigAction) -> Result<ExceptionState, KernelError> {
...
pub async fn do_signal_return() -> Result<ExceptionState, KernelError> {
    let task = current_task();
